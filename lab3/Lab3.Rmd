...
Evaluate the convergence of the samplet by saving the sampled parameters (theta. sigma2 and w) in Mattias code at each iteration and then plot the parameter trajectories over the iterations.

```{r,  out.width = "60%"}
knitr::include_graphics("1bPlot.PNG")
```
...
legend("topright", box.lty = 1, legend = c("Data density","Mixture density","Posterior density"), col=c("black","red","purple"), lwd = 2)
